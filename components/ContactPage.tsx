...
export default function ContactPage() {
  return (
    <main className="relative min-h-screen bg-black text-white overflow-hidden font-sans select-none">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[75vh] flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="flex-1 w-full h-full relative overflow-hidden filter grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
          <iframe 
